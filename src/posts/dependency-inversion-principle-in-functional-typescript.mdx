...
date: "2020-09-03"
coverImage: "../images/tim-gouw-He9WQV8e7Kk-unsplash.jpg"
...
Whenever a module relies on a abstraction (`interface` or `abstract class`) as dependency, that dependency can be swapped for another implementation, like a plugin.
